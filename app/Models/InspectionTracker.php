...
class InspectionTracker extends Model
{
    ...
    protected static function boot() {
		...
		static::creating(function(InspectionTracker $inspectionTracker) {
			$sequence = InspectionTracker::withTrashed()->count() + 1;
			$inspectionTracker->sequence_no = str_pad($sequence, 6, '0', STR_PAD_LEFT);
		});
	}
    ...
    public function trackerEmployees() {
        return $this->hasMany(InspectionTrackerEmployee::class, "tracker", "id");
    }
}
