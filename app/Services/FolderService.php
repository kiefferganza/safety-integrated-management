	...
	public function getFolders() {
		...
		->with([
			...
			'documents' => fn($q) => $q
				...
				->leftJoin('tbl_document_reviewer_sign', 'tbl_document_reviewer_sign.document_id', 'tbl_documents.document_id')
				->leftJoin('tbl_document_approval_sign', 'tbl_document_approval_sign.document_id', 'tbl_documents.document_id')
		])
		->orderBy("folder_id")
		->get()
		->toArray();
