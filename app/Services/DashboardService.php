...
class DashboardService {
	...
	public function getIncidents() {
		...
		if($incidents["fafr"]["monthTotal"] > 0 && $incidents["fafr"]["monthTotalHours"] > 0) {
		...
		if($incidents["trcf"]["total"] > 0 && $incidents["trcf"]["totalHours"] > 0) {
			$incidentReport["trcf"]["itd"] = round(($incidents["trcf"]["total"] * 200000) / $incidents["trcf"]["totalHours"]);
		}
		if($incidents["trcf"]["monthTotal"] > 0 && $incidents["trcf"]["monthTotalHours"] > 0) {
