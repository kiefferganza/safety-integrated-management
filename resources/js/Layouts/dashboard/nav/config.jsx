	...
	// ----------------------------------------------------------------------
	{
		...
		items: [
			...
			// Toolbox Talks
			{
				...
				routeNames: [
					"toolbox-talks.management.all",
					"toolbox-talks.management.civil",
					"toolbox-talks.management.electrical",
					"toolbox-talks.management.mechanical",
					"toolbox-talks.management.camp",
					"toolbox-talks.management.office",
					"toolbox-talks.management.new",
					"toolbox-talks.management.edit",
					"toolbox-talks.management.report",
					"toolbox-talks.management.statistic",
				],
				children: [
					{ title: 'create', gate: 'talk_toolbox_create', path: PATH_DASHBOARD.toolboxTalks.new("1"), routeNames: ["toolbox-talks.management.new"] },
					{ title: 'all', gate: 'talk_toolbox_show', path: PATH_DASHBOARD.toolboxTalks.root, routeNames: ["toolbox-talks.management.all"] },
					{ title: 'civil', gate: 'talk_toolbox_show', path: PATH_DASHBOARD.toolboxTalks.civil, routeNames: ["toolbox-talks.management.civil"] },
					{ title: 'electrical', gate: 'talk_toolbox_show', path: PATH_DASHBOARD.toolboxTalks.electrical, routeNames: ["toolbox-talks.management.electirical"] },
					{ title: 'mechanical', gate: 'talk_toolbox_show', path: PATH_DASHBOARD.toolboxTalks.mechanical, routeNames: ["toolbox-talks.management.mechanical"] },
					{ title: 'workshop', gate: 'talk_toolbox_show', path: PATH_DASHBOARD.toolboxTalks.camp, routeNames: ["toolbox-talks.management.camp"] },
					{ title: 'office', gate: 'talk_toolbox_show', path: PATH_DASHBOARD.toolboxTalks.office, routeNames: ["toolbox-talks.management.office"] },
					{ title: 'report', path: PATH_DASHBOARD.toolboxTalks.report, routeNames: ["toolbox-talks.management.report"] },
					{ title: 'statistic', path: PATH_DASHBOARD.toolboxTalks.statistic, routeNames: ["toolbox-talks.management.statistic"] },
				]
			},
