			...
			<Container maxWidth={themeStretch ? false : 'xl'}>
				<Grid container spacing={3}>
					...
					<Grid item xs={12} sm={6} md={4}>
						<FileGeneralWidget title="Dropbox" value={GB / 10} total={GB} icon="/storage/assets/icons/apps/ic_dropbox.svg" />
					</Grid>

					<Grid item xs={12} sm={6} md={4}>
						<FileGeneralWidget title="Drive" value={GB / 5} total={GB} icon="/storage/assets/icons/apps/ic_drive.svg" />
					</Grid>

					<Grid item xs={12} sm={6} md={4}>
						<FileGeneralWidget title="OneDrive" value={GB / 2} total={GB} icon="/storage/assets/icons/apps/ic_onedrive.svg" />
					</Grid>
