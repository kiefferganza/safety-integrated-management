...
const { NewPpeReport } = await import(
    "@/sections/@dashboard/ppe/portal/NewPpeReport"
);
const { PpeAnalytic } = await import("@/sections/@dashboard/ppe/PpeAnalytic");
const { PpeReportTableToolbar } = await import(
    "@/sections/@dashboard/ppe/details/PpeReportTableToolbar"
);
...
const PPEReportPage = ({
    ...
    const list = tableData.filter((data) =>
        selected.includes(data.inventory_id)
    );
                                                ...
                                                <TableCell>
                                                    ...
                                                    >
                                                        <Image
                                                            ...
                                                            src={
                                                                row.img_src
                                                                    ? `/storage/media/photos/inventory/${row.img_src}`
...
function applyFilter({ inputData, comparator, filterName, filterStatus }) {
    ...
    if (filterName) {
        inputData = inputData.filter(
            (product) =>
                product.item.toLowerCase().indexOf(filterName.toLowerCase()) !==
                -1
        );
    }
