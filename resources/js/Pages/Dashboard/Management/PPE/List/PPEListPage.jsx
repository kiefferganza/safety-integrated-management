...
export default function PPEListPage({ inventory }) {
    ...
    const TABS = [
        { value: "all", label: "All", color: "info", count: tableData.length },
        {
            ...
            label: "In Stock",
            color: "success",
            count: getLengthByStatus("in_stock"),
        },
        {
            value: "need_reorder",
            label: "Need Reorder",
            color: "info",
            count: getLengthByStatus("need_reorder"),
        },
        {
            value: "low_stock",
            label: "Low Stock",
            color: "warning",
            count: getLengthByStatus("low_stock"),
        },
        {
            value: "out_of_stock",
            label: "Out Of Stock",
            color: "error",
            count: getLengthByStatus("out_of_stock"),
        },
    ];
...
function applyFilter({
    ...
    if (filterByStatus !== "all") {
        inputData = inputData.filter(
            (product) => product.status === filterByStatus
        );
    }
    ...
    if (filterStartDate && !filterEndDate) {
        ...
        inputData = inputData.filter(
            (product) =>
                fTimestamp(new Date(product.date_updated)) >= startDateTimestamp
        );
    }
