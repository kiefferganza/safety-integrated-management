...
const spacing = {
    ...
    m4: { marginLeft: 4, marginRight: 4, marginTop: 4, marginBottom: 4 },
    ...
    p4: { paddingLeft: 4, paddingRight: 4, paddingTop: 4, paddingBottom: 4 },
    p16: {
        paddingLeft: 16,
        paddingRight: 16,
        paddingTop: 16,
...
const colorStyles = {
    ...
    offPrimary: { color: colors.offPrimary },
    ...
    bgInfo: { backgroundColor: colors.info, color: "#ffffff" },
