...
const TABLE_HEAD = [
    ...
    { id: "inprogress", label: "In Progress", align: "left" },
...
const PPEReportListPage = ({
    ...
    const handleResetFilter = () => {
        ...
        if (filterStartDate && filterEndDate) {
            Inertia.get(
                route("inspection.management.report"),
                {},
                {
                    preserveScroll: true,
                    preserveState: true,
    ...
    const dataRows = dataFiltered.slice(
        page * rowsPerPage,
                        ...
                        <Scrollbar>
                            ...
                            >
                                <TableHeadCustom
                                    ...
                                    rowCount={
                                        Object.values(inspectionReport).length
                                    }
                                    onSort={onSort}
                                    // onSelectAllRows={(checked) =>
                                    // 	onSelectAllRows(
                                ...
                                <TableBody>
                                    ...
                                    <TableEmptyRows
                                        ...
                                        emptyRows={emptyRows(
                                            page,
                                            rowsPerPage,
                                            Object.values(inspectionReport)
                                                .length
                                        )}
                                    />
...
function applyFilter({ inputData, comparator, filterName, filterType }) {
    ...
    if (filterName) {
        inputData = inputData.filter(
            (ins) =>
                ins.title.toLowerCase().indexOf(filterName.toLowerCase()) !==
                    -1 ||
    ...
    if (filterType.length > 0) {
        inputData = inputData.filter((ins) =>
            filterType.some((t) => t.toLowerCase() === ins.table.toLowerCase())
        );
    }
