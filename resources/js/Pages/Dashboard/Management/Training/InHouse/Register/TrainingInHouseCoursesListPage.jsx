...
const NewCourseSchema = Yup.object().shape({
    course_name: Yup.string().required("Name of the course is required."),
    acronym: Yup.string().required(
        "Please add an abbreviation name of this course."
    ),
    attached_file: Yup.mixed().required(
        "Please add attachment for this course"
    ),
});
const defaultValues = {
    course_name: "",
...
export default function TrainingCoursesListPage({ courses }) {
    ...
    const handleOpenEditCourse = (course) => {
        ...
        setValue("acronym", course.acronym ?? "");
    ...
    const handleCreateCourse = (data) => {
        const duplicateAbbv = courses.some(
            (c) => c.acronym === data.acronym && c.id !== data.id
        );
        if (duplicateAbbv) {
    ...
    const handleUpdateCourse = (data) => {
        ...
        Inertia.post(
            route("training.management.update_in_house_course", data.id),
            data,
            {
                onStart: () => {
