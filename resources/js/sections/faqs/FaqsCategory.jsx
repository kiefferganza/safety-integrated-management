...
const CATEGORIES = [
	{
		...
		icon: '/storage/assets/icons/faqs/ic_account.svg',
		href: '#',
	},
	{
		label: 'Payment',
		icon: '/storage/assets/icons/faqs/ic_payment.svg',
		href: '#',
	},
	{
		label: 'Delivery',
		icon: '/storage/assets/icons/faqs/ic_delivery.svg',
		href: '#',
	},
	{
		label: 'Problem with the Product',
		icon: '/storage/assets/icons/faqs/ic_package.svg',
		href: '#',
	},
	{
		label: 'Return & Refund',
		icon: '/storage/assets/icons/faqs/ic_refund.svg',
		href: '#',
	},
	{
		label: 'Guarantees and assurances',
		icon: '/storage/assets/icons/faqs/ic_assurances.svg',
		href: '#',
	},
];
