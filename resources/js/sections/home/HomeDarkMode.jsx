...
const StyledRoot = styled('div')(({ theme }) => ({
	...
	backgroundImage: `url('/storage/assets/background/overlay_4.jpg')`,
		...
		<StyledRoot>
			<Container component={MotionViewport}>
				...
				<m.div variants={varFade().inUp}>
					<Stack spacing={2} direction="row" alignItems="center" display="inline-flex">
						...
						<IconButton color={themeMode === 'dark' ? 'warning' : 'default'} onClick={onToggleMode}>
							<SvgColor
								src={`/storage/assets/icons/setting/ic_${themeMode === 'light' ? 'moon' : 'sun'}.svg`}
							/>
						</IconButton>
					</Stack>
				</m.div>
				...
				<m.div variants={varFade().inUp}>
					<Image
						alt="darkmode"
						src="/storage/assets/images/home/darkmode.jpg"
						sx={{
							borderRadius: 2,
							my: { xs: 5, md: 10 },
