		...
		<>
			...
			<Card sx={{ pt: { xs: 3, md: 5 }, px: { xs: 3, md: 8 } }}>
				<Box sx={{ mb: 2 }}>
					...
					<Box>
						<Typography variant="h4" textAlign="center">Toolbox Talk</Typography>
					</Box>
				</Box>
				...
				<Stack direction={{ xs: "column", md: "row" }} spacing={{ xs: 3, md: 0 }} justifyContent="space-between" sx={{ mb: 5 }}>
					...
					<Stack alignItems="center" flex={1}>
						...
						<Box>
							<Typography variant="body1" textAlign="center">{tbt?.revision_no || 0}</Typography>
						</Box>
					</Stack>
				...
				<Box sx={{ mt: 10 }} width={1} display="inline-block">
					...
					<Box width={200}>
						...
						<Box>
							<Typography textAlign="center" variant="body1" fontWeight={700}>Conducted by:</Typography>
						</Box>
					</Box>
				</Box>
