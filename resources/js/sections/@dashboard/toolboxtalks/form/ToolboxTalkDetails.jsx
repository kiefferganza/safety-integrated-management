...
const ToolboxTalkDetails = ({
    ...
    const handleRemoveFile = (inputFile) => {
        const removedFileIdx = values.img_src.findIndex(
            ...
            <Box sx={{ p: 3 }}>
                ...
                >
                    <Stack alignItems="flex-end" spacing={2}>
                        ...
                        >
                            <Autocomplete
                                ...
                                onChange={(_event, newValue) => {
                                    if (newValue) {
                                        setValue("conducted_by", newValue.id, {
                                            shouldValidate: true,
                                            shouldDirty: true,
                                        });
                                    } else {
                                        setValue("conducted_by", "", {
                                            shouldValidate: true,
                                            shouldDirty: true,
                                        });
                                    }
                                }}
                                options={[...participants, user.employee].map(
                                    (option) => ({
                        ...
                        <Divider
                            sx={{ my: 3, borderStyle: "dashed", width: 1 }}
                        />
