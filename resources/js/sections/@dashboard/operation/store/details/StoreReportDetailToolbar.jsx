...
import StoreReportPDF from './StoreReportPDF';

const StoreReportDetailToolbar = ({ inventoryReport }) => {
		...
		<>
			...
			>
				<Stack direction="row" spacing={1}>
					...
					<PDFDownloadLink
						document={<StoreReportPDF report={{ ...inventoryReport, shortLabel }} title={inventoryReport.form_number} />}
				...
				<Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
					...
					<Box sx={{ flexGrow: 1, height: '100%', overflow: 'hidden' }}>
						<PDFViewer width="100%" height="100%" style={{ border: 'none' }}>
							<StoreReportPDF report={{ ...inventoryReport, shortLabel }} title={inventoryReport.form_number} />
						</PDFViewer>
					</Box>
				</Box>
			</Dialog>
...
export default StoreReportDetailToolbar