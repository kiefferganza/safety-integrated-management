...
export default function TrainingDetails({
    ...
    if (training.type === 3) {
        ...
        training.status = getThirdPartyTrainingStatus(
            training.date_expired || new Date(),
            completed ? training.external_status.status === "closed" : completed
        );
    } else {
    ...
    const getTotalAmmount =
        training?.external_details && training?.type === 3
            ? training?.trainees?.length *
              parseInt(training?.external_details?.course_price)
            : 0;
                        ...
                        <Stack sx={{ mt: 6 }} spacing={3}>
                            ...
                            <Stack direction="row">
                                ...
                                <Box>
                                    <Typography variant="body1">
                                        {fCurrencyNumber(
                                            training?.external_details
                                                ?.course_price
                                        ) + ".00"}{" "}
                                        {training?.external_details?.currency}
                                    </Typography>
                                </Box>
                            </Stack>
                            <Stack direction="row">
                                ...
                                <Box>
                                    <Typography variant="body1">
                                        {fCurrencyNumber(getTotalAmmount) +
                                            ".00"}{" "}
                                        {training?.external_details?.currency}
                                    </Typography>
                                </Box>
                            ...
                            <Stack direction="row">
                                ...
                                <Box>
                                    <Typography variant="body1">
                                        {fDate(
                                            new Date(
                                                training?.external_details?.date_requested
                                            )
                                        )}
                                    </Typography>
                                </Box>
