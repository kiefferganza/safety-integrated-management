			...
			<Page size="A4" style={styles.page}>
				<View style={styles.mb32}>
					...
					<View style={styles.gridContainer}>
						<View style={[styles.col3, { alignItems: 'center', flexDirection: 'column' }]}>
							...
							<Text style={[styles.body1]}>{training.cms ? training.cms.toUpperCase() : ""}</Text>
						</View>
						<View style={[styles.col3, { alignItems: 'center', flexDirection: 'column' }]}>
							<Text style={styles.subtitle2}>Revision:</Text>
							<Text style={[styles.body1]}>{training.revision_no || 0}</Text>
						</View>
						<View style={[styles.col3, { alignItems: 'center', flexDirection: 'column' }]}>
				...
				<View style={[styles.gridContainer, styles.mb16]}>
					<View style={[styles.col6, { paddingRight: 8 }]}>
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Course Title</Text>
						...
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Training Location</Text>
							<View style={{ width: '100%' }}>
						...
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Contract No.</Text>
							<View style={{ width: '100%' }}>
						...
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Conducted By</Text>
							<View style={{ width: '100%' }}>
						...
						{training.training_center && (
							<View style={[styles.mb16, { flexDirection: 'column' }]}>
								<Text style={styles.body1}>Training Center</Text>
								<View style={{ width: '100%' }}>
					...
					<View style={[styles.col6, { paddingLeft: 8 }]}>
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Date of Training</Text>
							<View style={{ width: '100%' }}>
						...
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Date Expired</Text>
							<View style={{ width: '100%' }}>
						...
						<View style={[styles.mb16, { flexDirection: 'column' }]}>
							<Text style={styles.body1}>Training Hours</Text>
							<View style={{ width: '100%' }}>
					...
					<View style={styles.mb40}>
						<View style={styles.mb40}>
							<View style={[styles.gridContainer, styles.mb40]}>
								<Text style={styles.body1}>Remarks</Text>
							</View>
