...
PpeDetailsCarousel.propTypes = {
	inventory: PropTypes.object,
};

export default function PpeDetailsCarousel ({ inventory }) {
	...
	const images = inventory?.img_src ? [`/storage/media/photos/inventory/${inventory?.img_src}`] : []
	const imagesLightbox = inventory?.img_src ? [`/storage/media/photos/inventory/${inventory?.img_src}`] : [];
