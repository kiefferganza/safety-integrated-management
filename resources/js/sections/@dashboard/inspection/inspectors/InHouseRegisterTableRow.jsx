...
const InHouseAttachedFile = lazy(() => import('../../portal/InHouseAttachedFile'));
...
export default function InHouseRegisterTableRow ({ row, index, selected, onSelectRow, onDeleteRow, onUpdateRow }) {
