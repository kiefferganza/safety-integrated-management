...
Route::middleware('auth')->group(function ()
{
	...
	Route::get('dashboard/ppe/product/{inventory}', [InventoryController::class, "show"])->name('ppe.management.show');
	...
	Route::get('dashboard/ppe/product/{inventory}/edit', [InventoryController::class, "edit"]);
	Route::post('dashboard/ppe/product/{inventory}/update', [InventoryController::class, "update"]);
	...
	// Folder -> Documents
	Route::get('dashboard/file-manager/view', [DocumentController::class, "view"]);
